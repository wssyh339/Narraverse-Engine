...
OUTLINE_AGENT_PROMPTS: dict[str, str] = {
    ...
    "CharacterGeneratorAgent": "outline_character_generator",
    "SettingGeneratorAgent": "outline_setting_generator",
...
class OutlineSwarmAgentRunner:
    ...
    def _context(self, state: OutlineSwarmState) -> dict[str, Any]:
        return {
            ...
            "character_candidates": state.character_candidates,
            "setting_candidates": state.setting_candidates,
