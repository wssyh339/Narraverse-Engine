...
LONG_NOVEL_PROMPT_ENTRIES: tuple[PromptCatalogEntry, ...] = (
    ...
    PromptCatalogEntry("macro_outline", 4, "生成全书宏观大纲", "04_macro_outline_prompt.md", "outline_planning", "chapter_planner"),
    PromptCatalogEntry("ending_backcast", 5, "从结局反推路径", "05_ending_backcast_prompt.md", "outline_planning", "chapter_planner"),
    PromptCatalogEntry("volume_outline", 6, "生成分卷大纲", "06_volume_outline_prompt.md", "outline_planning", "chapter_planner"),
    PromptCatalogEntry("rolling_chapter_outline", 7, "生成当前卷滚动章节大纲", "07_rolling_chapter_outline_prompt.md", "outline_planning", "chapter_planner"),
...
PROMPT_WORKFLOWS: tuple[PromptWorkflowDefinition, ...] = (
    ...
    PromptWorkflowDefinition(
        ...
        label="全书与分卷规划",
        description="生成宏观大纲、结局反推路径、分卷大纲和滚动章纲。",
        prompt_ids=("macro_outline", "ending_backcast", "volume_outline", "rolling_chapter_outline"),
    ),
    PromptWorkflowDefinition(
