...
SQLITE_COLUMN_DEFAULTS: dict[str, dict[str, str]] = {
    "projects": {
        ...
        "planned_volume_count": "INTEGER NOT NULL DEFAULT 1",
        "chapters_per_volume": "INTEGER NOT NULL DEFAULT 0",
        "chapter_word_min": "INTEGER NOT NULL DEFAULT 0",
        "chapter_word_max": "INTEGER NOT NULL DEFAULT 0",
    ...
    "chapters": {
        ...
        "crisis": "TEXT NOT NULL DEFAULT ''",
        "climax": "TEXT NOT NULL DEFAULT ''",
        "outcome": "TEXT NOT NULL DEFAULT ''",
        "chapter_hook": "TEXT NOT NULL DEFAULT ''",
        "foreshadowing_plants_json": "TEXT NOT NULL DEFAULT '[]'",
        "foreshadowing_payoffs_json": "TEXT NOT NULL DEFAULT '[]'",
        "canon_updates_json": "TEXT NOT NULL DEFAULT '[]'",
        "continuity_risks_json": "TEXT NOT NULL DEFAULT '[]'",
